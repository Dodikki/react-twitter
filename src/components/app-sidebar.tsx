    ...
    <Sidebar className="border-r flex flex-col h-screen" variant="sidebar" collapsible="none">
      ...
      <SidebarFooter className="border-t px-4 py-3">
        <Link to="/profile" className="flex items-center gap-3 rounded-full p-2 ">
            <img
            src="https://lastfm.freetls.fastly.net/i/u/ar0/e98817458bc87a3fa8e1f7896a5cb0ac.jpg"  
            className="size-10 rounded-full object-cover"
            alt="Avatar"
            />
            <div className="flex flex-col">
            <p className="text-sm font-bold">Roberto</p>
            <p className="text-sm text-[#6E767D]">@Rob_topXD</p>
            </div>
        </Link>
       </SidebarFooter>
    </Sidebar>
